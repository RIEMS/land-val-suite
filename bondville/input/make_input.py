...
with open(INFILE, "rt") as f:
    for line in f:
        ...
        year = int(line_parts[0])
        month = int(line_parts[1])
        day = int(line_parts[2])
        hour = int(line_parts[3])
        minute = int(line_parts[4])
